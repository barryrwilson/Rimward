 ...
 *     NOTE (wave 39): metalness is capped at 0.35. The project has no
 *     environment map, so a high metalness kills the diffuse term and the
 *     authored hull color renders near-black on every face the sun does not
 *     strike. Relative ordering is preserved (ferrous highest, assembly and
 *     beautiful lowest). Raise these only alongside an envMap.
