...
async function pursuit(h){
  ...
  result.reacquisition=await bounded('native reacquisition',s=>s.intent&&s.target==='player',()=>control(0));await checkpoint('04-departure-reacquisition');await act('clearControl');
