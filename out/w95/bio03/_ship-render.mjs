 ...
 *
 * Output: out/w95/bio03/stills/<faction>-render.png
 */
...
import { canvas, clearDepth, tri, label, png } from '../../../scripts/raster.mjs';
...
writeFileSync(`out/w95/bio03/stills/${faction}-render.png`, png(sheet));
console.log(`${faction}: out/w95/bio03/stills/${faction}-render.png (${classes.join(', ')})`);
