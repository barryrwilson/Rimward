 ...
 *
 * Output: out/w95/bio03/stills/<faction>-shape.png and -scale.png
 */
...
mkdirSync('out/w95/bio03/stills', { recursive: true });
...
for (const faction of targets) {
  ...
  writeFileSync(`out/w95/bio03/stills/${faction}-shape.png`, png(shape));
  ...
  writeFileSync(`out/w95/bio03/stills/${faction}-scale.png`, png(scaleSheet));

  console.log(
    `${faction}: out/w95/bio03/stills/${faction}-shape.png, ${faction}-scale.png`
