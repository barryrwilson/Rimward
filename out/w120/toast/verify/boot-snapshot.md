    ...
    - generic:
      ...
      - generic:
        - list:
          ...
          - listitem: P — pause
  - dialog "RIMWARD title screen" [ref=f2e5]:
    - generic [ref=f2e6]:
      - generic [ref=f2e7]: A LIVING FRONTIER
      - button "[1] CONTINUE" [ref=f2e8] [cursor=pointer]
      - button "[2] NEW GAME" [ref=f2e9] [cursor=pointer]
      - button "[3] MODELS" [ref=f2e10] [cursor=pointer]
      - button "[4] SETTINGS" [ref=f2e11] [cursor=pointer]
      - generic [ref=f2e12]: PRESS 1-4 OR CLICK