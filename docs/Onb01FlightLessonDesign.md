...
| **Date** | 2026-08-27 |
| **Status** | Wave 141 leftover census + brief. No `src/`. Merge law: shared-contract.md wins. |
| **Wave** | 141 — leftover census + brief. No `src/`. KeyH/J/L/M/P stay. KeyD strafe. Digit 0/8/9 stay. Origin Digit1–5 stay origin until pick. |
...
| **Merge law** | [`out/w141/onb01/shared-contract.md`](../out/w141/onb01/shared-contract.md). If this document and that file conflict, **the contract wins**. |
