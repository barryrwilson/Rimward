...
| **Date** | 2026-08-27 |
| **Status** | Design freeze Wave 141. Merge law: shared-contract.md wins. No `src/`. |
| **Wave** | 141 — leftover census + brief. No `src/`. KeyH/J/L/M/P stay. KeyD strafe. Digit 0/8/9 stay station after pick. Digit1–5 stay origin until pick. |
...
| **Merge law** | [`out/w141/org01/shared-contract.md`](../out/w141/org01/shared-contract.md). If this document and that file conflict, **the contract wins**. |
