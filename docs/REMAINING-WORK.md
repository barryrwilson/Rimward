...
| A pirate may claim the crew and the hull of a yielded trader | [#147](https://github.com/barryrwilson/Rimward/issues/147) | Open; depends on #146. The station run and record purse from #151 (`ai.fence`, `fenceHaul`, `rec.credits`) are the sale leg this issue can reuse. |
