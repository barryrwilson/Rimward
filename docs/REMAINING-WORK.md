...
|---|---:|---|
| [OPT-001](https://github.com/barryrwilson/Rimward/issues/8) | P3 | Evidence refreshed; verification complete. Live pass on `e38360f3` (2026-08-28) rates Hail01, HUD-06, Hail02, HUD-07, NAV-09, TGT-07, and CTL-03 all PASS, 7/7, with 0 console errors. TGT-07 gets its first live browser coverage. No defect found, so nothing reopened. Set: `out/w143/opt001/verify/` (rerun `node scripts/opt001-live-probe.mjs`). |
