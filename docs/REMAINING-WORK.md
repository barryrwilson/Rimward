...
OPT-001 evidence refresh, and the parked RW-002 PR3–PR5 / RW-005 working tree.
...
| [RW-002](https://github.com/barryrwilson/Rimward/issues/3) | P2 | PR1–PR2 on master. PR3–PR5 parked on `wip/rw-002-pr3-pr5-rw-005` (bind map, KEYS UI, overlay copy). GitHub #3 is closed. Next: land that branch. | Expand Settings with mouse sensitivity, invert X/Y, complete conflict-aware key rebinding, and separate music/effects/voice/UI volume. Brief: [Ctl06ExpandedSettingsDesign.md](Ctl06ExpandedSettingsDesign.md). | [2026-08-25 playtest capture](PLAYER-EXPERIENCE-WISHLIST.md#playtest-capture--2026-08-25-latest-67fb1a0-build) |
...
| [RW-005](https://github.com/barryrwilson/Rimward/issues/6) | P3 | Implemented in working tree; owner choice 1 2026-08-28 | Keep zero-cost recovery. Overlay copy states no UU charge. Autosave restore and no-save Freehold starter are unchanged. Brief: [DeathLossPolicyDesign.md](DeathLossPolicyDesign.md). | [Second 2026-08-25 playtest](PLAYER-EXPERIENCE-WISHLIST.md#playtest-capture--2026-08-25-second-pass-agent-playtest-67fb1a0-build) |
