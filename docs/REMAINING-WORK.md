...
### Issue #179 — market pane costs, caps and transient prices (implementation, review pending)
...
browser checks pass with zero console errors; independent QA remains pending.
