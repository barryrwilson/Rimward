...
| [OPT-004](https://github.com/barryrwilson/Rimward/issues/11) | P3 | Implemented; release gate pending. Reproduced Settings/pause fire leaks and cleared physical holds at ownership boundaries; fresh flight fire still breaks hail demands. Focused and full boot checks pass. The changed artifact exceeds the unchanged byte budget and requires an explicitly approved exact-artifact exception before completion. See [Issue11FireHeldEvidence.md](Issue11FireHeldEvidence.md). |
